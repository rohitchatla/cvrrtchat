...
function Thread({ threadinfo, dispatch, channelID, checkprivate }) {
  ...
  function deleteThread() {
    ...
    if (confirm === true) {
      if (checkprivate) {
        axios
          .delete(`/api/comments/g/${threadinfo.id}`, {
          ...
          .then(res => {
            ...
            // appDispatch({
            //   type: 'DELETE_THREAD',
            //   data: { id: threadinfo.id, parentID: threadinfo.parent_id, channelID },
            // });
            // socket.emit('delete_thread', {
            //   id: threadinfo.id,
            //   parentID: threadinfo.parent_id,
            //   channelID,
            // });
          })
          .catch(err => {
    ...
    if (checkprivate) {
      axios
        ...
        .then(res => {
          ...
          // appDispatch({
          //   type: 'EDIT_THREAD',
          //   data: { text, id: threadinfo.id, parentID: threadinfo.parent_id, channelID },
          // });
          // socket.emit('edit_thread', {
          //   text,
          //   id: threadinfo.id,
          //   parentID: threadinfo.parent_id,
          //   channelID,
